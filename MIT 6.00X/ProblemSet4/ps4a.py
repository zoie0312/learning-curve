    ...
    while user_input != '.':
        ...
        if not isValidWord(user_input, hand, wordList):
            ...
            if loop_nr > 0 and n == 0:
                ...
                score -= 50
                print(user_input + ' earned ' + str(turn_score - 50) + ' points. Total: ' + str(score) + ' points')
                print
            else:
                # Update the hand 
                print(user_input + ' earned ' + str(turn_score) + ' points. Total: ' + str(score) + ' points')
                print
            if n == 0:
